...
#
# --RH389--
# This script normally resides in node_modules/react-native but is included
# in a modified form here to allow code to be bundled in a simulator run, in
# order to run UI tests in CI environment without running the packager in
# parallel.
# --END RH389--
#
